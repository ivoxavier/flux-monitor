            ...
            <div style={{ marginTop: 24 }}>
              ...
              <Timeline
                items={[
                  {
                    color: 'red',
                    children: `${selectedAlert.dataHora} - Alerta gerado automaticamente`,
                  },
                  {
                    color: 'blue',
                    children: `${selectedAlert.dataHora} - Atribuído a ${selectedAlert.responsavel}`,
                  },
                  {
                    color: 'gray',
                    children: `${selectedAlert.dataHora} - Em investigação`,
                  },
                  ...(selectedAlert.estado === 'resolvido'
                    ? [{
                        color: 'green',
                        children: `${selectedAlert.dataHora} - Resolvido`,
                      }]
                    : []),
                ]}
              />
